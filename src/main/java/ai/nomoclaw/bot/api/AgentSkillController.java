...
/**
 * Controller for agent skill listing and enable/disable operations.
 */
@RestController
@RequestMapping("/api")
@Slf4j
public class AgentSkillController {
    ...
    /**
     * Returns all skills with agent-scoped enabled status.
     */
    ...
    public List<AgentSkillResponse> listAgentSkills(@PathVariable String agentUid) {
        ...
        return ApiDtoMapper.toAgentSkills(agentSkillService.listAgentSkills(agentUid));
    }

    /**
     * Updates one skill enabled flag for the target agent.
     */
    ...
    public AgentSkillResponse updateAgentSkillStatus(@PathVariable String agentUid,
        ...
        return ApiDtoMapper.toAgentSkill(agentSkillService.updateAgentSkillStatus(agentUid, skillKey, request.enabled()));
    }
}
