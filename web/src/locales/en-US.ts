const enUS = {
  ...
  pages: {
    ...
    knowledge: {
      ...
      chunks: { title: "Document chunks", subtitle: "Inspect every chunk generated for the current document version.", empty: "No chunks yet", copy: "Copy chunk content", copied: "Chunk content copied" },
      parseWarnings: {
