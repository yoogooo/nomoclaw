const enUS = {
  ...
  chat: {
    ...
    trace: {
      ...
      back: "Back to chat",
      refresh: "Refresh",
      invalidLink: "Invalid trace link",
      loadFailed: "Failed to load traces",
      loadFailedHint: "The call records are temporarily unavailable. Please try again.",
      retry: "Retry",
      loading: "Loading trace…",
      detailFailed: "Failed to load trace details",
      messageUnavailable: "Message unavailable",
      empty: "No LLM trace was captured for this message",
      timeline: "Call timeline",
      detail: "Call details",
      roundAttempt: "Round {round} · Attempt {attempt}",
      round: "Round {round}",
      roundAttemptLabel: "Round / Attempt",
      tokens: "tokens",
      inputTokens: "Input",
      ...
      requestUid: "Request ID",
      provider: "Provider:",
      model: "Model:",
      systemPrompt: "System prompt",
      messages: "Full message context",
      ...
      noResponse: "No text, thinking, or tool calls were returned for this round.",
      rawProtocol: "Raw provider protocol",
      protocol: "Protocol",
      endpoint: "Endpoint",
      responseStatus: "Response status",
      requestHeaders: "Request headers (safe fields)",
      rawRequestJson: "Raw request JSON",
      rawResponseJson: "Raw response JSON",
      streamEvents: "SSE stream events",
      nonStreaming: "Non-streaming call",
      rawUnavailable: "This trace was created before raw protocol capture was enabled.",
