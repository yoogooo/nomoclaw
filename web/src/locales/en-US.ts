const enUS = {
  ...
  chat: {
    ...
    runtime: {
      ...
      approvalRiskHintSensitiveRead: "Security notice: reading this sensitive path may expose keys or credentials. Confirm before continuing.",
      approvalRiskHintProtectedPath: "Security notice: the target is under a protected directory. Confirm this matches your intent before proceeding.",
      approvalRiskHintSystemPathDeny: "Security notice: this targets a critical system path and is high risk. Rejecting is recommended.",
      approvalRiskHintRuleAsk: "Policy notice: this action matched an ask rule and requires your confirmation.",
      approvalRiskHintDefaultAsk: "Policy notice: no allow rule matched, so manual confirmation is required by default.",
