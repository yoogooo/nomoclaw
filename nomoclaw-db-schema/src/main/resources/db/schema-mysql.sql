...
CREATE TABLE IF NOT EXISTS agent_conversation (
    ...
    last_user_message_time DATETIME(3) NOT NULL COMMENT '最后一次用户提问时间',
    created_time DATETIME(3) NOT NULL COMMENT '创建时间',
    updated_time DATETIME(3) NOT NULL COMMENT '更新时间',
    PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS llm_provider_model (
    ...
    model_type VARCHAR(32) NOT NULL DEFAULT 'TEXT_GENERATION' COMMENT '模型主分类',
    capabilities_json JSON NOT NULL COMMENT '结构化模型能力 JSON',
